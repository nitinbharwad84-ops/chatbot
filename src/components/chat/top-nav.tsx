...
import { Settings, LogOut, ChevronDown, LogIn, UserPlus } from 'lucide-react'
        ...
        <div className="flex items-center gap-4">
          {user ? (
            ...
            <div className="flex items-center gap-3">
              <Link 
                href="/login" 
                className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-[#96a9e6] hover:text-white transition-colors"
              >
                <LogIn size={18} />
                Log In
              </Link>
              <Link 
                href="/signup" 
                className="flex items-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-[#32457c] to-[#0a2257] text-sm font-bold text-white shadow-lg shadow-blue-500/10 hover:opacity-90 transition-all"
              >
                <UserPlus size={18} />
                Sign Up
              </Link>
